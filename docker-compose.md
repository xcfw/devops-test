...
First short reference on ruby structure: 
...
4. Now please write a compose file to make db and sha-service run together. Make a curl post and get requests to the sha-service app localhost address, that you just deployed and see if it works.
